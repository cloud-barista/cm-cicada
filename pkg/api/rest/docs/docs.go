...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/pkg_api_rest_controller.CreateWorkflowReq"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/pkg_api_rest_controller.UpdateWorkflowReq"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "pkg_api_rest_controller.CreateWorkflowReq": {
            "type": "object",
            "required": [
                "data",
                "id"
        ...
        "pkg_api_rest_controller.UpdateWorkflowReq": {
            "type": "object",
            "required": [
                "data"
            ],
